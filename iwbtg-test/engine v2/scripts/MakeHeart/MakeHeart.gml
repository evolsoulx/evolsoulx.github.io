...
/// @arg speed
/// @arg obj
function MakeHeart(argument0,argument1,argument2,argument3,argument4,argument5,argument6){
	var dx = argument0;
	var dy = argument1;
	...
	for(var i=num-1;i>=0;i--)
	{
		...
		inst[i] = instance_create_layer(dx,dy,dlayer,obj);
		inst[i].speed = spd*rate[i];
		inst[i]._rate = rate[i];
