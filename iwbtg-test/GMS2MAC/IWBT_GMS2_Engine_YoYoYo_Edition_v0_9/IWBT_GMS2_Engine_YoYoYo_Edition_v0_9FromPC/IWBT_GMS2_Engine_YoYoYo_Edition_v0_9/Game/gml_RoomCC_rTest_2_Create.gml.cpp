...
extern YYVAR g_Script_gml_RoomCC_rTest_2_Create;
#ifndef __YYNODEFS
#else
#endif // __YYNODEFS

void gml_RoomCC_rTest_2_Create( CInstance* pSelf, CInstance* pOther );
#ifndef __YYNODEFS
void gml_RoomCC_rTest_2_Create( CInstance* pSelf, CInstance* pOther )
{
YY_STACKTRACE_FUNC_ENTRY( "gml_RoomCC_rTest_2_Create", 0 );
